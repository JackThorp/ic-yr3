...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2b0afad33cf8, const void *arg_0x2b0afad32020);
#line 780
__extension__ 
#line 797
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2b0afaff58e8), 
int (*key_eq_fn)(void *arg_0x2b0afaff40c8, void *arg_0x2b0afaff4368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b0afb205610, int arg_0x2b0afb205878);
static inline double RandomUniform(void );
...
# 75 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
static void BlinkC$toggle$runTask(void );
# 62 "/usr/src/tinyos/tos/interfaces/Init.nc"
...
# 67 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
static error_t BlinkC$toggle$postTask(void );
# 67 "/usr/src/tinyos/tos/interfaces/Leds.nc"
static void BlinkC$Leds$led0Toggle(void );
# 21 "BlinkC.nc"
enum BlinkC$__nesc_unnamed4331 {
#line 21
  BlinkC$toggle = 3U
};
#line 21
typedef int BlinkC$__nesc_sillytask_toggle[BlinkC$toggle];
#line 16
...
static inline void BlinkC$toggle$runTask(void );
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2b0afb5f9020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2b0afb5f9020, msg, payload, len);
#line 78
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2b0afb5fa340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2b0afb5fa340, msg, payload, len);
#line 78
...
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2b0afb5fb220, message_t * msg, error_t error){
#line 110
    TossimActiveMessageC$AMSend$default$sendDone(arg_0x2b0afb5fb220, msg, error);
#line 110
}
#line 110
...
#line 21
{
  sim_log_debug(148U, "MyBlinkC", "Toggle Task being executed.\n");
...
# 75 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2b0afb306020){
#line 75
  switch (arg_0x2b0afb306020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2b0afb306020);
#line 75
      break;
#line 75
    }
...
#line 53
# 67 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static error_t BlinkC$toggle$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(BlinkC$toggle);
#line 67
...
static inline void BlinkC$Timer0$fired(void )
{
  sim_log_debug(149U, "MyBlinkC", "Timer 0 fired @ %s.\n", sim_time_string());
  BlinkC$toggle$postTask();
}
...
# 83 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2b0afba46c28){
#line 83
  switch (arg_0x2b0afba46c28) {
#line 83
    case 0U:
#line 83
      BlinkC$Timer0$fired();
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2b0afba46c28);
#line 83
      break;
#line 83
    }
